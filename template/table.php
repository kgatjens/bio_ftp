...
<div class="bs-docs-grid">
	<div class="row show-grid">
	  ...
	  <div class="col-md-8"><?php echo $data['sequense']['SpeciesNo']?></div>
	</div>
	<div class="row show-grid">
	  <div class="col-md-4"><h5>SequenceNo</h5></div>
	  <div class="col-md-8"><?php echo $data['sequense']['SequenceNo']?></div>
	</div>
	<div class="row show-grid">
	  <div class="col-md-4"><h5>SequenceDesc</h5></div>
	  <div class="col-md-8"><?php echo $data['sequense']['SequenceDesc']?></div>
	</div>
	<div class="row show-grid">
	  <div class="col-md-4"><h5>SequenceLength</h5></div>
	  <div class="col-md-8"><?php echo $data['sequense']['SequenceLength']?></div>
	</div>	
</div>
